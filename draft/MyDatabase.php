	...
	class MyDatabase extends Database {
		...
		*/
		public function insert($aParams) {
			try {
				$oStmt = $this->oDB->prepare("INSERT INTO users (login, email, password, birth_date, photo, city_id, gender)
											VALUES ( :login, :email, :password, :birth_date, :photo, :city_id, :gender );");
				$oStmt->bindParam(":login",$aParams['login']);
		...
		*/
		public function getField($id) {
			try {
				$oStmt = $this->oDB->prepare("	SELECT 	users.login as login,
